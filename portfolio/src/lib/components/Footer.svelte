<footer class="footer bg-neutral text-pale-yellow text-neutral-content py-10 px-8 sm:px-18 md:px-24 lg:px-46">
  <div class="flex w-full items-center justify-between gap-6">
    ...
    <nav class="flex items-center justify-center font-lalezar text-xl">
      <div class="flex flex-row items-center gap-4 md:gap-6 text-md">
        ...
        <a href="/resume" class="hover:text-bubble-gum">Impressum</a>
      </div>
    </nav>

    <div class="flex flex-col items-end gap-3">
      <a href="https://www.linkedin.com/in/ilse-l%C3%B6hr-687b681b8" aria-label="LinkedIn" class="inline-flex items-center justify-center w-7 h-7">
